	...
	; Compiler options:
	;
	; -occ_2033anmo.cof -mcc_2033anmo.map --summary=default \
	; --output=default cc_2033anmo.p1 cc_fun.p1 cc_int.p1 cc_key.p1 \
	; cc_app.lpp --chip=16F1938 -P --runtime=default --opt=default \
